...
import com.iamskorpz.watchioiptv.data.m3u.M3uParser
...
class M3uParserTest {
    ...
    private suspend fun parse(value: String) = mutableListOf<com.iamskorpz.watchioiptv.data.m3u.ParsedM3uItem>().also { items ->
