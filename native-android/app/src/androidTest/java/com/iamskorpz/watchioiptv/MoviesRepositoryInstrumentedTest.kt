...
import com.iamskorpz.watchioiptv.core.database.ProviderEntity
...
class MoviesRepositoryInstrumentedTest {
    ...
    fun seriesPagesAreBoundedStableAndDoNotLoadEpisodes() = runBlocking {
        ...
        database.seriesDao().upsertAll((0 until 325).map { index ->
            com.iamskorpz.watchioiptv.core.database.SeriesEntity(
        ...
        val repository = com.iamskorpz.watchioiptv.data.series.SeriesRepository(
        ...
        val all = com.iamskorpz.watchioiptv.data.series.SeriesCategory("all", "ALL SERIES", com.iamskorpz.watchioiptv.data.series.SeriesCategoryKind.All)
    ...
    fun continueWatchingCategoryFiltersAndSortsResumableMoviesOnly() = runBlocking {
        ...
        historyRepo.upsert(com.iamskorpz.watchioiptv.domain.repository.HistoryItem(providerId, com.iamskorpz.watchioiptv.domain.model.ContentType.Movie, "m-1", title = "Movie 1", positionMs = 120_000L, durationMs = 600_000L, lastWatchedAtEpochMs = 100))
        // s-1: episode (should be excluded)
        historyRepo.upsert(com.iamskorpz.watchioiptv.domain.repository.HistoryItem(providerId, com.iamskorpz.watchioiptv.domain.model.ContentType.Episode, "s-1", subContentId = "e-1", title = "Show 1", positionMs = 120_000L, durationMs = 600_000L, lastWatchedAtEpochMs = 90))
        // m-deleted: not in catalog (should be excluded)
        historyRepo.upsert(com.iamskorpz.watchioiptv.domain.repository.HistoryItem(providerId, com.iamskorpz.watchioiptv.domain.model.ContentType.Movie, "m-deleted", title = "Deleted", positionMs = 120_000L, durationMs = 600_000L, lastWatchedAtEpochMs = 80))
        // m-2: completed (should be excluded)
        historyRepo.upsert(com.iamskorpz.watchioiptv.domain.repository.HistoryItem(providerId, com.iamskorpz.watchioiptv.domain.model.ContentType.Movie, "m-2", title = "Movie 2", positionMs = 590_000L, durationMs = 600_000L, lastWatchedAtEpochMs = 70))
        // m-3: resumable (older)
        historyRepo.upsert(com.iamskorpz.watchioiptv.domain.repository.HistoryItem(providerId, com.iamskorpz.watchioiptv.domain.model.ContentType.Movie, "m-3", title = "Movie 3", positionMs = 80_000L, durationMs = 600_000L, lastWatchedAtEpochMs = 60))
    ...
    fun seriesCatalogLoadsZeroEpisodesAndResolvesContinueWatchingTargeted() = runBlocking {
        ...
        val episodes = (1..50).flatMap { sIndex ->
            (1..5).map { epIndex ->
                com.iamskorpz.watchioiptv.core.database.EpisodeEntity(
                    providerId = providerId.value,
                    seriesId = "s-$sIndex",
        ...
        val seriesRepo = com.iamskorpz.watchioiptv.data.series.SeriesRepository(
            database = database,
        ...
        val allCategory = com.iamskorpz.watchioiptv.data.series.SeriesCategory("all", "ALL SERIES", com.iamskorpz.watchioiptv.data.series.SeriesCategoryKind.All)
        ...
        database.watchHistoryDao().upsert(
            com.iamskorpz.watchioiptv.core.database.WatchHistoryEntity(
                providerId = providerId.value,
                contentType = com.iamskorpz.watchioiptv.domain.model.ContentType.Episode.persisted,
                contentId = "s-5",
        ...
        val cwCategory = com.iamskorpz.watchioiptv.data.series.SeriesCategory("continue_watching", "CONTINUE WATCHING", com.iamskorpz.watchioiptv.data.series.SeriesCategoryKind.ContinueWatching)
