...
class EpgRepositoryInstrumentedTest {
    ...
    fun setup() = runBlocking {
        ...
        repository = EpgRepository(
            database = database,
            okHttpClient = com.iamskorpz.watchioiptv.core.network.NetworkModule().okHttpClient,
        ...
        ProviderCredentialStore(secrets).saveXtreamCredentials("xt", com.iamskorpz.watchioiptv.core.security.XtreamCredentials("fake-user", "fake-pass"))
    }
    ...
    private fun parserTime(value: String): Long = com.iamskorpz.watchioiptv.data.epg.XmlTvParser().parseXmlTvTime(value)!!
