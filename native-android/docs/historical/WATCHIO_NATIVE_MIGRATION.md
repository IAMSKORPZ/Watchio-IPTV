# WATCHIO NATIVE ANDROID MIGRATION SPECIFICATION (HISTORICAL)

Archived historical planning document. It describes the old Flutter-to-native migration and must not be treated as current architecture. Current architecture lives in `native-android/docs/ARCHITECTURE.md` and related subsystem docs.
